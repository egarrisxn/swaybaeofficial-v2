              ...
              <>
                <aside className='order-2 md:order-1'>
                  <Image
                    ...
                    width={750}
                    height={1000}
                    className='rounded-3xl border-2 border-slate-200 shadow-xl'
                  />
                </aside>
                <article className='order-1 flex h-full flex-col justify-between px-2 py-8 md:order-2'>
                  <div className='text-start md:text-end'>
                    ...
                    <h3 className='leading-snug font-medium tracking-tight text-black lg:text-lg xl:text-xl 3xl:text-2xl dark:text-white'>
                ...
                <article className='flex h-full flex-col justify-between px-2 py-8'>
                  ...
                  <div className='mt-8 flex justify-start'>
                    ...
                    >
                      ...
                      <ArrowRightIcon className='mr-1 size-4 transition group-hover:translate-x-1' />
                    </button>
                  </div>
                </article>
                <aside>
