    ...
    <section className='relative overflow-hidden'>
      ...
      <div className='relative px-6 pt-12 pb-24 md:pt-16 md:pb-32 lg:pt-20 lg:pb-40'>
        <div className='mx-auto max-w-4xl text-center'>
          ...
          <h1 className='bg-gradient-to-br from-foreground via-foreground to-accent bg-clip-text pb-4 text-[2.65rem] leading-none font-bold tracking-tighter text-transparent text-shadow-lg sm:text-5xl md:pt-1 md:pb-6 md:text-6xl lg:text-7xl xl:text-8xl'>
