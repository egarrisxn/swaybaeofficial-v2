  ...
  return (
    ...
    >
      ...
      <div className='absolute z-10 flex size-full flex-col items-center justify-center border px-4 pb-20 text-center'>
        <h1 className='font-serif text-5xl leading-none font-black tracking-tighter text-white text-shadow-md text-shadow-primary/80 motion-safe:animate-hero-pop sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl 2xl:text-[9rem] 3xl:text-[10rem] 4xl:text-[11rem]'>
          Creator of Chaos
        </h1>
      </div>
