  ...
  "inline-flex items-center justify-center cursor-pointer gap-2 whitespace-nowrap rounded-full font-semibold transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        blue: `bg-linear-to-b from-[#00f0ff] to-[#00ffea]  shadow-[${shadows.blue.base}] hover:bg-[right_top] hover:shadow-[${shadows.blue.hover}] active:shadow-[${shadows.blue.active}] dark:shadow-[${shadows.blue.dark}] dark:hover:shadow-[${shadows.blue.darkHover}] dark:active:shadow-[${shadows.blue.darkActive}]`,
        pink: `bg-linear-to-b from-[#ff00ff] to-[#ff00dd]  hover:bg-[right_top] shadow-[${shadows.pink.base}] hover:shadow-[${shadows.pink.hover}] active:shadow-[${shadows.pink.active}] dark:shadow-[${shadows.pink.dark}] dark:hover:shadow-[${shadows.pink.darkHover}] dark:active:shadow-[${shadows.pink.darkActive}]`,
